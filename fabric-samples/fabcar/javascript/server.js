...
var deal=12;
app.get('/ajax/donate', async (req, res) => {
	var amount = req.query.amount;
	console.log(amount.toString());

	await mainCreate(deal,amount.toString());
	deal++;
	res.send(["捐款成功！"]);
	});
...
//插入
async function mainCreate(deal,amount) {
    try {
	...
	var a='DEAL';
        ...
        await contract.submitTransaction('createDeal', a.concat(deal.toString()), 'John', '红十字会', amount, '2019-5-26');
