...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	deals := []Deal{
		Deal{Name: "John", Org: "红十字会", Sum: "10", Date: "2019-1-1"},
		Deal{Name: "John", Org: "红十字会", Sum: "10", Date: "2019-1-1"},
		Deal{Name: "John", Org: "中国青年志愿者协会", Sum: "10", Date: "2019-1-1"},
		Deal{Name: "John", Org: "中华志愿者协会", Sum: "10", Date: "2017-1-1"},
		Deal{Name: "Jhon", Org: "中国儿童少年基金会", Sum: "10", Date: "2017-2-1"},
		Deal{Name: "Jhon", Org: "中国儿童少年基金会", Sum: "10", Date: "2018-1-1"},
		Deal{Name: "Jhon", Org: "中国儿童少年基金会", Sum: "10", Date: "2018-1-1"},
		Deal{Name: "Jhon", Org: "中华志愿者协会", Sum: "10", Date: "2017-1-1"},
		Deal{Name: "Jhon", Org: "中华志愿者协会", Sum: "10", Date: "2018-1-1"},
		Deal{Name: "Jhon", Org: "红十字会", Sum: "10", Date: "2017-1-1"},
	}
